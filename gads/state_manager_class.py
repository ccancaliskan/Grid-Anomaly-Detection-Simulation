...
class StateManager:
    ...
    def __new__(cls):
        if cls._instance is None:
            ...
            cls._instance._initialize_session_state()
        return cls._instance

    def _initialize_session_state(self, force=False):
        ...
        st.session_state.current_attack_targets = []
                        ...
                        st.session_state.halt_on_non_convergence = False # New state variable
                 # New state variable
