...
def _apply_load_and_attacks(t, net, current_attack_type, attacked_buses):
...
def run_simulation_step(error_placeholder, attack_info_placeholder, network_plot_placeholder, voltage_chart_placeholder):
    ...
    is_attacked, current_attack_type, attacked_buses = _determine_and_display_attack_status(t, attack_info_placeholder)
    ...
    if state_manager.get_is_running():
        net = _apply_load_and_attacks(t, net, current_attack_type, attacked_buses)
